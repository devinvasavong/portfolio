    ...
    return (
        <div>
            <div id="header">
                ...
                <p className={`text-sm ${isVisible ? 'opacity-100 translate-y-0 blur-0' : 'opacity-0 translate-y-3 blur-sm'} transition-all duration-1000 ease-out will-change-transform`} style={{ transitionDelay: '50ms' }}>Software Engineer &amp; Entrepreneur</p>
            </div>
            <div id="links" className={`mt-12 flex flex-row gap-2 ${isVisible ? 'opacity-100 translate-y-0 blur-0' : 'opacity-0 translate-y-3 blur-sm'} transition-all duration-1000 ease-out will-change-transform`} style={{ transitionDelay: '100ms' }}>
                ...
                <Link href="https://cdn.vasavong.dev/files/Chanthanong_Devin_Vasavong_Resume.pdf" className="bg-gray-100 hover:bg-gray-200 text-gray-500 px-2 py-1 rounded-full transition-colors duration-300 text-sm">Resume</Link>
            </div>
